...
@redsen:registry=https://pkgs.dev.azure.com/YOUR_ORG/_packaging/YOUR_FEED/npm/registry/
always-auth=true
```
...
```bash
npm install @redsen/mat-datatable
```
...
export class ServerSideTableComponent implements OnInit {
  ...
  private loadData(params?: { sort?: Sort; page?: PageEvent; filters?: Record<string, unknown> }): void {
    this.loading = true;
...
- Email: support@redsen.ch, acheddir@outlook.fr
